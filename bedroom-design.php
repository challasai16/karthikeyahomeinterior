...
<html lang="en" dir="ltr">
  <head>
    <?php
       include "head.php";
    ?>
    <title>Bedroom Design - Karthikeya Home Interior</title>
    <style media="screen">
      .swiper {
        width: 100%;
        height: 85vh;
...
<section class="living-room-hero kitchen-room-hero bedroom-hero">
  <div class="living-room-hero-container">
    <div class="living-room-hero-left living-room-hero-box">
      ...
      <h1>Bedroom Room Interior Design</h1>
        <p>Better Experience with Your Bed Room Design </p>
      <a href="#bedroom">KNOW MORE</a>
    </div>
  ...
  <section class="living-room-feature">
   ...
   <div class="works-container">
       ...
       <div class="responsive">
        <!--1-->
        <div class="slider">
            <img src="media/bedroom/bedroom-1.png">
        </div>
        <!--2-->
        <div class="slider">
            <img src="media/bedroom/bedroom-2.png">
        </div>
        <!--3-->
        <div class="slider">
            <img src="media/bedroom/bedroom-3.png">
        </div>
        <!--4-->
        <div class="slider">
            <img src="media/bedroom/bedroom-4.png">
        </div>
        <!--5-->
        <div class="slider">
            <img src="media/bedroom/bedroom-5.png">
        </div>
