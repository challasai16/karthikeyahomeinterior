...
<html lang="en" dir="ltr">
  <head>
    <?php
      include "head.php";
    ?>
    <title>Kitche Design - Karthikeya Home Interior</title>
    <style media="screen">
...
<section class="living-room-hero kitchen-room-hero">
  <div class="living-room-hero-container">
    <div class="living-room-hero-left living-room-hero-box">
      ...
      <h1>Kitchen Room Interior Design</h1>
        <p>Better Experience with Your Kitchen Room</p>
      <a href="#kitchen">KNOW MORE</a>
    </div>
...
<section class="living-room-what">
   <div class="living-room-whatcontainer"  id="kitchen">
     <div class="living-room-what-left living-room-whatbox">
       <img src="media/kitchen-main.png" alt="">
     </div>
     <div class="living-room-what-right living-room-whatbox">
       <h3>How we bring light up to Your Kitchen room Designing</h3>
 ...
 <section class="living-room-feature">
   ...
   <div class="works-container">
       ...
       <div class="responsive">
        <!--1-->
        <div class="slider">
            <img src="media/kitchen/kitchen-1.png">
        </div>
        <!--2-->
        <div class="slider">
            <img src="media/kitchen/kitchen-2.png">
        </div>
        <!--3-->
        <div class="slider">
            <img src="media/kitchen/kitchen-3.png">
        </div>
        <!--4-->
        <div class="slider">
            <img src="media/kitchen/kitchen-4.png">
        </div>
        <!--5-->
        <div class="slider">
            <img src="media/kitchen/kitchen-5.png">
        </div>
